...
var CheckboxTreeItem = function (_Component) {
    ...
    CheckboxTreeItem.prototype.getBranchValue = function getBranchValue() {
        ...
        return {
            ...
            values: [],
            children: this.childCheckboxItems ? _lodash2.default.map(this.childCheckboxItems, function (c) {
    ...
    CheckboxTreeItem.prototype.setCheckedState = function setCheckedState(state, callback) {
        ...
        if (children) _lodash2.default.map(children, function (c, id) {
    ...
    CheckboxTreeItem.prototype.renderChildren = function renderChildren() {
        ...
        return _lodash2.default.map(children, function (d, key) {
            return _react2.default.createElement(CheckboxTreeItem, { key: key, id: key, ref: _this4.addChildRef, item: d, accessors: accessors, depth: depth + 1, parent: _this4, checked: isChecked || d.isChecked, treeUpdateTrigger: treeUpdateTrigger });
        });
    };
    ...
    CheckboxTreeItem.prototype.render = function render() {
        ...
        return _react2.default.createElement(
            ...
            _react2.default.createElement('input', { type: 'checkbox', onChange: this.onCheckToggle, checked: isChecked }),
            label,
...
exports.default = CheckboxTreeItem;
