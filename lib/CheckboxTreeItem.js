...
exports.CheckboxTreeItem = undefined;
...
var CheckboxTreeItem = exports.CheckboxTreeItem = function (_React$Component) {
  ...
  CheckboxTreeItem.prototype.getValues = function getValues() {
    ...
    if (checkedState === 'checked') {
      ...
      var childValues = _lodash2.default.map(this.childCheckboxItems.filter(function (c) {
        return c.checkedState !== 'unchecked';
      }), function (c) {
        return c.getValues();
      });

      _lodash2.default.map(childValues, function (c) {
  ...
  CheckboxTreeItem.prototype.setCheckedState = function setCheckedState(state, callback) {
    ...
    if (children) {
      _lodash2.default.map(children, function (c, id) {
  ...
  CheckboxTreeItem.prototype.renderChildren = function renderChildren() {
    ...
    return _lodash2.default.map(children, function (d, key) {
      ...
      }, (0, _helperFunctions.constructItemProperties)(d, accessors, depth + 1, childState)));
    });
  };
...
CheckboxTreeItem.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  accessors: _propTypes2.default.array,
  parent: _propTypes2.default.object,
  onUpdateTree: _propTypes2.default.func.isRequired,
